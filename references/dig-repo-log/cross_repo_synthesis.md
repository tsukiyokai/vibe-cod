...
| 仓库 | 类型 | 总提交 | 缺陷数 | 缺陷率 | 规则数 | 缺陷类别数 |
|------|------|--------|--------|--------|--------|-----------|
| hccl | 通信-主 | 428 | 84 | 19.6% | 48 | 11 |
| hcomm-dev | 通信-dev | 488 | 162 | 33.1% | 40 | 12 |
| hccl-dev | 通信-dev | 133 | 10 | 7.5% | 9 | 5 |
| ops-transformer | 算子-主 | 1323 | 243 | 18.4% | 46 | 11 |
| ops-nn | 算子-主 | 1474 | 380 | 25.8% | 39 | 12 |
| ops-nn-dev | 算子-dev | 2571 | 612 | 23.8% | 34 | 18 |
| ops-transformer-dev | 算子-dev | 2820 | 788 | 27.9% | 42 | 15 |
...
- 分析仓库: /Users/shanshan/repo/cann/ 下8个仓库
- 单仓产物: 本目录下 hccl/, hcomm-dev/, hccl-dev/, ops-transformer/, ops-nn/, ops-nn-dev/, ops-transformer-dev/ 子目录
