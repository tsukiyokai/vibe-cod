...
| 支持型号                                    | 数据通路                                                                                                         |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Atlas训练系列产品                           | GM -> VECINGM -> A1、B1VECIN -> VECCALC或VECCALC -> VECOUTVECOUT -> GM                                           |
| Atlas推理系列产品AI Core                    | GM -> VECINGM -> A1、B1VECIN -> VECCALC或VECCALC -> VECOUTVECIN、VECCALC、VECOUT -> A1、B1VECOUT、CO2 -> GM      |
| Atlas推理系列产品Vector Core                | GM -> VECINVECOUT -> GM                                                                                          |
